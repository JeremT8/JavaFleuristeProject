...
function getStyles() {
	...
	$.get("http://localhost:8080/tp-fleuriste/rs/styles", afficherStyles);
}
...
function ajouterStyle() {
	...
	$.ajax({
		type: 'post',
		url: 'http://localhost:8080/tp-fleuriste/rs/styles',
...
function suppStyle(id){
	$.ajax({
		type : 'delete',
		url : 'http://localhost:8080/tp-fleuriste/rs/styles/' + id,
		success : function(){
			getStyles();
		}
	})
